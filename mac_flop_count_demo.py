# -*- coding: utf-8 -*-
"""demo_metaformer_baselines.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1raon_oZRnUBXb9ZYcMY3Au_r-3l4eP1I

# MetaFormer Baselines for Vision

This is a demo example to run MetaFormer baselines (IdentityFormer, RandFormer, PoolFormerV2, ConvFormer and CAFormer) for image classification, introduced by
[MetaFormer Baselines for Vision](https://arxiv.org/abs/2210.13452).

More detail can be found in [this repo](https://github.com/sail-sg/metaformer).
